    ...
    public class CodeGenerator
    {
        ...
        private TargetCode GenerateCodeFor(IAbstractSyntaxTreeNode node)
        {
            if (node is null)
            {
                ...
                Reporter.AddError(node.Position, "Tried to generate code for a null tree node");
                return null;
            }
            else if (node is ErrorNode)
            {
                ...
                Reporter.AddError(node.Position, "Tried to generate code for an error tree node");
                return null;
            }
            else
            {
                ...
                if (function == null)
                {
                    ...
                    string error = $"Couldn't find the function {functionName} when generating code";
                    Reporter.AddError(node.Position, error);
                    return null;
                }
                else
        ...
        private void GenerateCodeForAssignCommand(AssignCommandNode assignCommand)
        {
            ...
            {
                Debugger.Write("The identifier is not a variable and you should have picked this problem up during type checking found " + assignCommand.Identifier.Declaration.ToString());
                Reporter.AddError(assignCommand.Position, "The identifier is not a variable and you should have picked this problem up during type checking found " + assignCommand.Identifier.Declaration.ToString());
            }
        ...
        private void GenerateCodeForRepeatCommand(RepeatCommandNode repeatCommand)
        {
            ...
            GenerateCodeFor(repeatCommand.UntilExpression);
            code.AddInstruction(OpCode.JUMPIF, Register.CB, FalseValue, jumpAddress);
        ...
        private void GenerateCodeForIdExpression(IdExpressionNode idExpression)
        {
            ...
            else
            {
                ...
                Reporter.AddError(idExpression.Position, "The identifier is not a constant or variable and you should have picked this problem up during type checking");
            }
        }
        ...
        private void GenerateCodeForVarParameter(VarParameterNode varParameter)
        {
            ...
            else
            {
                ...
                Reporter.AddError(varParameter.Position, "The identifier is not a variable and you should have picked this problem up during type checking");
            }
        ...
        private void GenerateCodeForIdentifier(IdentifierNode identifier)
        {
            ...
            else
            {
                ...
                Reporter.AddError(identifier.Position, "The identifier declaration isn't one of the built in functions and you should have picked this problem up during type checking");
            }
        ...
        private void GenerateCodeForOperator(OperatorNode operation)
        {
            ...
            else
            {
                ...
                Reporter.AddError(operation.Position, "The identifier declaration isn't one of the built in functions and you should have picked this problem up during type checking");
