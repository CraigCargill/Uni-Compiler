    ...
    public static class StandardEnvironment
    {
        ...
        public static ImmutableDictionary<string, IDeclarationNode> GetItems()
        {
            return new Dictionary<string, IDeclarationNode>()
            {
                ...
                { GreaterThanOrEqualTo.Name, GreaterThanOrEqualTo },
        ...
        public static BinaryOperationDeclarationNode GreaterThanOrEqualTo { get; } = new BinaryOperationDeclarationNode(">=", GE, IntegerType, IntegerType, BooleanType);
        public static BinaryOperationDeclarationNode LessThanOrEqualTo { get; } = new BinaryOperationDeclarationNode("<=", LE, IntegerType, IntegerType, BooleanType);
